...
namespace Service3_NewForcus {
    ...
    public partial class MyServiceActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(MyServiceActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(MyServiceActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(MyServiceActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".MyServiceActivity.g.xaml") || resource.Equals("MyServiceActivity.g.xaml"))) {
                    return resource;
                }
            }
